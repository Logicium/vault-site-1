...
import { CalendarClock, BedDouble, ShoppingBag, UtensilsCrossed, Ticket, Sparkles, Check } from 'lucide-vue-next'
...
<template>
  <section class="adm-page">
    ...
    <template v-else>
      ...
      <div class="ao-grid">
        <div v-for="a in ADDONS" :key="a.id" class="adm-card ao-card" :class="{ 'is-on': enabled.includes(a.id) }">
